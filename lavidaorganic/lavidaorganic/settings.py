# Django settings for lavidaorganic project.
import os
DEBUG = True
...
DATABASES = {
    'default': {
        ...
        'NAME': 'lavidaorganic_db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '=av*3mn$ap@d%-@@we@*8gd8sy-c!5z&dq12hc%b%8n=ch2gbf'
...
ROOT_URLCONF = 'lavidaorganic.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'lavidaorganic.wsgi.application'
